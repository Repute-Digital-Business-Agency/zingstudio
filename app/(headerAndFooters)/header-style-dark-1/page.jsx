...
export const metadata = {
  title:
    "Header Dark Style 1 || Zing Studio specializes in web design, digital marketing, and brand identity, delivering creative, cost-effective, and impactful solutions.",
...
export default function Header2Dark() &lbrace;
  return (
