...
export const metadata = {
  title:
    "Header Dark Style 3 || Zing Studio specializes in web design, digital marketing, and brand identity, delivering creative, cost-effective, and impactful solutions.",
                ...
                <div className="header-box">
                  <div className="row align-items-center">
                    ...
                    <div className="col-lg-9 col-md-8">
                      <h2 className="title">Check Header Style 03</h2>
                      <p>
...
export default function Header1Dark() &lbrace;
  return (
    &lt;header className&#x3D;&quot;site-header mo-left header dark&quot;&gt;
