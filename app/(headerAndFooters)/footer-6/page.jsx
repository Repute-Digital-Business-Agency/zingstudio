...
export const metadata = {
  title: "Footer 6 || Zing Studio specializes in web design, digital marketing, and brand identity, delivering creative, cost-effective, and impactful solutions.",
          ...
          >
            <div className="container">
              <div className="dlab-bnr-inr-entry">
                <h1 className="text-white">Footer 6</h1>
                {/* Breadcrumb row */}
                ...
                <div className="footer-box">
                  <div className="row align-items-center">
                    ...
                    <div className="col-lg-9 col-md-8">
                      <h2 className="title">Check Footer Style 06</h2>
                      <p>
