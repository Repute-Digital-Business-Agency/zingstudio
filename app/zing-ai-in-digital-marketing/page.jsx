  ...
  const services10 =   [
    {
      ...
      title: "Orientation & AI Basics <b style='font-size: 18px; color: #1a43bf; font-weight:500'> (Day 1) </b>",
      description:
    ...
    },
    {
      ...
      title: "AI in SEO & Content <b style='font-size: 18px; color: #1a43bf; font-weight:500'> (Day 2) </b>",
      description:
        "Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam.",
      animation: "bounceInUp",
      delay: "0.6s",
    ...
    },
    {
      ...
      title: "AI-Powered Campaigns <b style='font-size: 18px; color: #1a43bf; font-weight:500'> (Day 3) </b>",
      description:
        "Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam.",
      animation: "bounceInUp",
      delay: "0.9s",
    ...
    },
    {
      ...
      title: "AI for Analytics <b style='font-size: 18px; color: #1a43bf; font-weight:500'>(Day 4) </b>",
      description:
        "Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam.",
      animation: "bounceInUp",
      delay: "0.9s",
    ...
    
    {
      ...
      title: "Evaluation & Project Showcase <b style='font-size: 18px; color: #1a43bf; font-weight:500'> (Day 5) </b>",
      description:
        "Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam.",
      animation: "bounceInUp",
      delay: "0.3s",
