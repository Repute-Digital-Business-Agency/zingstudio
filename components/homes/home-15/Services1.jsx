...
export default function Services1() {
  return (
    <div className="section-full content-inner bg-white relative" style={{ backgroundImage: "url(/images/about-us/about-bg.jpg)", backgroundRepeat:"no-repeat", width:"100%", backgroundSize:"cover", backgroundPosition:"center" }}>
