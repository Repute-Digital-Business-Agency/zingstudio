...
const slidesData = [
  {
    ...
    title: "<span style='color: #fff'>ZING STUDIO</span><br/>Elevate Your Brand, Amplify Your Impact",
    description:
  ...
  },
  {
    ...
    title: "<span style='color: #fff'>WEB DESIGN </span><br/>Smart, sleek, and user-focused",
    description:
      "Delivering sophisticated, cutting-edge web solutions with Zing Studio—your creative partner in digital excellence.",
    buttonLabel: "BUY & VIEW SERVICES",
  ...
  },
  {
    ...
    title: "<span style='color: #fff'>DIGITAL MARKETING </span><br/> Fueling brand growth digitally",
    description:
  ...
  },
  {
    ...
    title:
      "<span style='color: #fff'>ZING ACADEMY</span><br/>Transforming students into professionals",
    description:
      "Shaping future entrepreneurs and skilled professionals through educational excellence.",
    buttonLabel: "BUY & VIEW SERVICES",
    link:"/zing-academy"
