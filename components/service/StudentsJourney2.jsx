...
export default function StudentsJourney2() {
    const services10 =   [
        {
          id: 137,
    ...
    <div className="section-head text-black text-center">
        ...
        <div className="col-md-12">
            <div className="main-timeline5">
                ...
                <div className="timeline">
                    <div className="timeline-icon"><span className="year">6</span></div>
                    <div className="timeline-content">
                ...
                <div className="timeline">
                    <div className="timeline-icon"><span className="year">7</span></div>
                    <div className="timeline-content">
